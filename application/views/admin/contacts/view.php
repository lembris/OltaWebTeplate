...
<div class="page-header">
    ...
    <div class="d-flex gap-2">
        <a href="<?= base_url('admin/contacts/reply/' . $enquiry->uid) ?>" class="btn btn-success">
...
<div class="row">
    ...
    <div class="col-lg-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <?= form_open('admin/contacts/update_status/' . $enquiry->uid, ['id' => 'statusForm']) ?>
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    ...
                    <button type="button" class="btn btn-outline-danger" 
                            onclick="confirmDelete('<?= base_url('admin/contacts/delete/' . $enquiry->uid) ?>', 'contact')">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('addNoteForm').addEventListener('submit', function(e) {
        ...
        fetch('<?= base_url('admin/contacts/add_note/' . $enquiry->uid) ?>', {
            method: 'POST',
            headers: {
...
<div class="modal fade" id="emailModal" tabindex="-1" aria-labelledby="emailModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="<?= base_url('admin/contacts/send_email/' . $enquiry->uid) ?>" method="POST">
