...
<div class="page-header">
    ...
    <div>
        ...
        <a href="<?= base_url('admin/enquiries/export?type=contact') . ($current_status ? '&status=' . $current_status : '') ?>" class="btn btn-outline-secondary">
    ...
    <div class="card-body py-3">
        <form method="get" class="row g-3 align-items-end">
            ...
            <div class="col-md-4">
                ...
                <a href="<?= base_url('admin/enquiries/contacts') ?>" class="btn btn-outline-secondary">Reset</a>
            </div>
        </form>
    </div>
</div>
                            ...
                            <tr class="<?= $enquiry->status === 'new' ? 'table-warning' : '' ?>">
                                ...
                                <td>
                                    <div class="action-btns">
                                        <a href="<?= base_url('admin/enquiries/view_contact/' . $enquiry->uid) ?>" 
                                        ...
                                        <button type="button" 
                                                ...
                                                onclick="confirmDelete('<?= base_url('admin/enquiries/delete/' . $enquiry->uid) ?>', 'contact query')">
            ...
            <nav aria-label="Page navigation" class="mt-4">
                <ul class="pagination justify-content-center">
                    <?php if ($current_page > 1): ?>
                        <li class="page-item">
                            <a class="page-link" href="<?= base_url('admin/enquiries/contacts?page=' . ($current_page - 1) . ($current_status ? '&status=' . $current_status : '') . ($search ? '&search=' . urlencode($search) : '')) ?>">
                    ...
                    <?php for ($i = max(1, $current_page - 2); $i <= min($total_pages, $current_page + 2); $i++): ?>
                        <li class="page-item <?= $i === $current_page ? 'active' : '' ?>">
                            <a class="page-link" href="<?= base_url('admin/enquiries/contacts?page=' . $i . ($current_status ? '&status=' . $current_status : '') . ($search ? '&search=' . urlencode($search) : '')) ?>"><?= $i ?></a>
                        </li>
                    <?php endfor; ?>
