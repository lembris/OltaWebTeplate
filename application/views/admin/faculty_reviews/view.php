<div class="container-fluid py-4">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <a href="<?= base_url('admin/faculty_reviews') ?>" class="text-decoration-none">
                ...
                <div class="card-body">
                    ...
                    <div class="btn-group-vertical w-100" role="group">
                        <?php if ($review->status != 'approved'): ?>
                            <form method="POST" action="<?= base_url('admin/faculty_reviews/approve/' . $review->id) ?>" style="display: inline;" 
                        ...
                        <?php if ($review->status != 'rejected'): ?>
                            <form method="POST" action="<?= base_url('admin/faculty_reviews/reject/' . $review->id) ?>" style="display: inline;" 
                                  onsubmit="return confirm('Are you sure you want to reject this review?');">
                                <?= form_hidden($this->security->get_csrf_token_name(), $this->security->get_csrf_hash()) ?>
                                <button type="submit" class="btn btn-warning mb-2 w-100">
                                    <i class="fas fa-ban mr-2"></i>Reject Review
                                </button>
                            </form>
                        <?php endif; ?>

                        <form method="POST" action="<?= base_url('admin/faculty_reviews/delete/' . $review->id) ?>" style="display: inline;" 
