            ...
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <h1 class="h3 d-flex align-items-center gap-2 mb-2">
                        <i class="fas fa-star text-warning"></i>Reviews
                    </h1>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <form method="get" class="row g-3 align-items-end">
                ...
                <div class="col-md-2">
                    ...
                    <select name="type" class="form-select form-select-sm">
                        ...
                        <?php foreach ($review_types as $type): ?>
                            <option value="<?= $type->type ?>" <?= $filters['type'] == $type->type ? 'selected' : '' ?>>
                                <?= ucfirst($type->type) ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <!-- Faculty Filter (only show if theme has faculty reviews) -->
                <?php if ($has_faculty_reviews): ?>
                <div class="col-md-2">
                ...
                <div class="col-12">
                    ...
                    <a href="<?= base_url('admin/reviews') ?>" class="btn btn-secondary btn-sm">
                        <i class="fas fa-redo mr-2"></i>Reset
                    </a>
                    <a href="<?= base_url('admin/reviews/export?status=' . $filters['status'] . '&faculty_id=' . $filters['faculty_id']) ?>" 
        ...
        <div class="table-responsive">
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    <?php if (!empty($reviews)): ?>
                        <?php foreach ($reviews as $review): ?>
                            <tr>
                                ...
                                <?php if ($has_faculty_reviews): ?>
                                <td>
                                    <a href="<?= base_url('admin/reviews?faculty_id=' . $review->faculty_id) ?>">
                                ...
                                <td>
                                    <div class="dropdown">
                                        <button class="btn btn-sm btn-outline-secondary" type="button" data-bs-toggle="dropdown" title="Actions">
                                            <i class="fas fa-ellipsis-v"></i>
                                        </button>
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a class="dropdown-item" href="<?= base_url('admin/reviews/view/' . $review->uid) ?>">
                                                    <i class="fas fa-eye me-2"></i> View Details
                                                </a>
                                            </li>
                                            <?php if ($review->status != 'approved'): ?>
                                            <li>
                                                <a class="dropdown-item text-success" href="#" onclick="confirmAction('<?= base_url('admin/reviews/approve/' . $review->uid) ?>', 'approve', 'review')">
                                            ...
                                            <li>
                                                <a class="dropdown-item text-warning" href="#" onclick="confirmAction('<?= base_url('admin/reviews/reject/' . $review->uid) ?>', 'reject', 'review')">
                                            ...
                                            <li>
                                                <a class="dropdown-item text-danger" href="#" onclick="confirmDelete('<?= base_url('admin/reviews/delete/' . $review->uid) ?>', 'review')">
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="<?= $has_faculty_reviews ? 9 : 8 ?>" class="text-center py-4 text-muted">
