...
<div class="page-header">
    <div>
        <h1 class="page-title">Add YouTube Video</h1>
    ...
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="<?= base_url('admin-youtube/create') ?>" id="videoForm">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" 
                                  ...
                                  class="form-control"
                                  rows="4"
                                  placeholder="Enter video description"><?= set_value('description') ?></textarea>
        ...
        <div class="card sticky-top" style="top: 20px;">
            ...
            <div class="card-body">
                <div class="video-preview">
                    <div id="previewThumbnail" class="mb-3" style="display: none;">
                        <img id="thumbnailImg" src="" alt="Thumbnail" class="img-fluid rounded">
                    </div>
                    <div id="previewInfo">
                        <p class="text-muted text-center mb-0">
                            <i class="fas fa-info-circle me-2"></i>Paste YouTube URL above to see preview
                        </p>
                    </div>
                </div>
            </div>
