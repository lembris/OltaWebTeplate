...
<div class="container-fluid page-wrapper">
    <div class="page-header mb-4">
        ...
        <p class="text-muted">Browse our faculty and staff members</p>
    </div>
                ...
                <nav class="mt-4">
                    <ul class="pagination justify-content-center">
                        <?php if ($current_page > 1): ?>
                            <li class="page-item">
                                <a class="page-link" href="<?php echo base_url('faculty?page=1'); ?>">First</a>
                            </li>
                            <li class="page-item">
                                <a class="page-link" href="<?php echo base_url('faculty?page=' . ($current_page - 1)); ?>">Previous</a>
                            </li>
                        <?php endif; ?>

                        <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                            <li class="page-item <?php echo ($i == $current_page) ? 'active' : ''; ?>">
                                <a class="page-link" href="<?php echo base_url('faculty?page=' . $i); ?>"><?php echo $i; ?></a>
                            </li>
                        <?php endfor; ?>

                        <?php if ($current_page < $total_pages): ?>
                            <li class="page-item">
                                <a class="page-link" href="<?php echo base_url('faculty?page=' . ($current_page + 1)); ?>">Next</a>
                            </li>
                            <li class="page-item">
                                <a class="page-link" href="<?php echo base_url('faculty?page=' . $total_pages); ?>">Last</a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </nav>
