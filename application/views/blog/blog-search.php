            ...
            <div class="col-lg-8">
                ...
                <?php else: ?>
                    <div class="alert alert-info">
                        ...
                        <p>Sorry, we couldn't find any posts matching "<strong><?php echo htmlspecialchars($keyword); ?></strong>". 
                        Try using different keywords or browse our <a href="<?php echo base_url('blog'); ?>">blog page</a>.</p>
                    </div>
                <?php endif; ?>
            </div>
