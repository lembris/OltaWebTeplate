    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="<?php echo base_url('events/register/' . $event->id); ?>">
                        <div class="row g-3">
                            <div class="col-md-6">
                        ...
                        <div class="mt-4 d-flex gap-3">
                            ...
                            <a href="<?php echo base_url('events/view/' . $event->id); ?>" class="btn btn-outline-secondary btn-lg">
                                Cancel
                            </a>
                        </div>
                    </form>
