                ...
                <article class="event-article">
                    ...
                    <div class="event-share mt-5 pt-4 border-top">
                        ...
                        <div class="share-buttons d-flex gap-2 flex-wrap">
                            <button class="btn btn-outline-primary btn-sm" onclick="shareEvent('<?php echo $event->uid; ?>')">
                ...
                <?php if ($event->registration_required || !empty($event->registration_link)): ?>
                    <div class="card mb-4 shadow-sm sticky-top" style="top: 20px;">
                        <div class="card-body">
                            ...
                            <?php if ($event->registration_required): ?>
                                <a href="<?php echo base_url('events/register/' . $event->uid); ?>" class="btn btn-lg w-100" style="background-color: var(--primary-color, #C7805C); color: #fff; border: 1px solid var(--primary-color, #C7805C);">
