        ...
        <div class="row no-gutters slider-text align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                <p class="breadcrumbs">
                    ...
                    <span><?php echo ucfirst($type); ?> <i class="fa fa-chevron-right"></i></span>
                </p>
                <h1 class="mb-0 bread"><?php echo ucfirst($type); ?></h1>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
            ...
            <div class="col-lg-8">
                <form method="get" action="<?php echo base_url('directory/search'); ?>" class="form-inline">
                    <div class="input-group w-100">
                        <input type="text" name="q" class="form-control" placeholder="Search by name, email, phone..." required>
                ...
                <div class="col-lg-4">
                    <div class="btn-group d-flex flex-wrap gap-2" role="group">
                        ...
                        <?php foreach ($types as $t): ?>
                            <a href="<?php echo base_url('directory/by_type/' . $t->type); ?>" class="btn btn-sm btn-outline-secondary <?php echo ($t->type == $type) ? 'active' : ''; ?>">
        ...
        <?php else: ?>
            <div class="alert alert-info text-center py-5">
                ...
                <h5>No entries found for this category</h5>
                <p class="text-muted">Try selecting a different category or search</p>
            </div>
        <?php endif; ?>
    </div>
</section>
