                    ...
                    <?php if ($has_events): ?>
                        <div class="day-events">
                            <?php foreach (array_slice($events_by_date[$current_date], 0, 2) as $event): ?>
                                <a href="<?php echo base_url('events/view/' . $event->slug); ?>" class="event-dot" title="<?php echo htmlspecialchars($event->title); ?>">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <a href="<?php echo base_url('events/view/' . $event->slug); ?>" class="btn btn-sm btn-outline-primary">View Details</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
