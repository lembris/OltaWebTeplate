        ...
        <div class="row g-5 align-items-center mb-5">
            <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s">
                <div class="destination-image position-relative overflow-hidden rounded-4 shadow-lg">
                    <img src="<?php echo base_url(); ?>assets/img/sections/osiram-safari-adventure-katavi-buffalo.jpg" class="img-fluid w-100" alt="Katavi National Park" style="height: 500px; object-fit: cover;">
                    <div class="destination-badge">
                        <span class="badge bg-primary px-3 py-2 rounded-pill">
                            <i class="fas fa-leaf me-1"></i> Untouched Wilderness
                        </span>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3s">
                <div class="destination-content">
                    <span class="destination-label text-primary fw-bold text-uppercase mb-2 d-block">
                        <i class="fas fa-map-marker-alt me-2"></i>Southwestern Tanzania
                    </span>
                    <h1 class="display-5 fw-bold mb-4">An Untouched Wilderness Retreat</h1>
                    <p class="lead text-muted mb-4">
                        Nestled in the southwestern region of Tanzania, Katavi National Park offers a secluded haven amid breathtaking landscapes, far from the usual safari crowds. With limited visitors each year, encounters with wildlife take center stage.
                    </p>
                    <p class="mb-4">
                        Established in 1974, Katavi spans an impressive 4,471km², making it the third-largest national park in Tanzania. It boasts the Katuma River, Lake Chada floodplains, and seasonal Lake Katavi.
                    </p>
                    <div class="destination-stats d-flex flex-wrap gap-4 mb-4">
                        ...
                        <div class="stat-item text-center">
                            ...
                            <h5 class="mb-0">3rd Largest</h5>
                            <small class="text-muted">In Tanzania</small>
                        </div>
                        <div class="stat-item text-center">
                            <div class="stat-icon bg-primary bg-opacity-10 rounded-circle p-3 mb-2 mx-auto" style="width: 60px; height: 60px;">
                                <i class="fas fa-calendar-alt text-primary fa-lg"></i>
                            </div>
                            <h5 class="mb-0">Since 1974</h5>
        ...
        <div class="row g-4 mt-5">
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="info-card h-100 p-4 rounded-4 shadow-sm border-0 bg-white">
                    ...
                    <p class="text-muted mb-0">
                        Swiftly reach Katavi with a 4-5 hr chartered flight from Arusha or Dar es Salaam. Fly to Kilimanjaro Intl. Airport or Julius Nyerere Intl. Airport for convenience.
                    </p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                <div class="info-card h-100 p-4 rounded-4 shadow-sm border-0 bg-white">
                    ...
                    <p class="text-muted mb-0">
                        Vast herds of Cape Buffaloes, zebras, giraffes, and elephants. Crocodiles and hippos along the Katuma River. Cheetahs, wild dogs, hyenas, leopards, and lions roam the park.
                    </p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="info-card h-100 p-4 rounded-4 shadow-sm border-0 bg-white">
                    ...
                    <p class="text-muted mb-0">
                        Walking safaris with armed rangers, bush camping, game drives. Birdwatching with 400+ species. Historical sights including the Kabora-Lyonga slave route.
                    </p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                <div class="info-card h-100 p-4 rounded-4 shadow-sm border-0 bg-white">
                    ...
                    <p class="text-muted mb-0">
                        <strong>June to December</strong> (Dry season). Witness abundant wildlife gathering around the Katuma River. Enjoy a serene park experience.
                    </p>
                </div>
            </div>
        </div>
...
<!-- Gallery Section -->
<?php $this->load->view('pages/sections/katavi-gallery-v3'); ?>
