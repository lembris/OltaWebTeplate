    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                <!-- Page Header -->
                <div class="mb-5">
                    <h1 class="page-title"><?php echo ucfirst(str_replace('-', ' ', $category)); ?></h1>
                    <p class="page-subtitle">Travel insights and tips in this category</p>
                </div>
                    ...
                    <div class="sidebar-widget mb-4">
                        ...
                        <ul class="category-list">
                            ...
                            <?php foreach ($categories as $cat): ?>
                                <?php $cat_slug = str_replace(' ', '-', strtolower($cat->category)); ?>
                                <li class="<?php echo ($cat->category == $category) ? 'active' : ''; ?>">
                                    <a href="<?php echo base_url('blog/category/' . $cat_slug); ?>">
