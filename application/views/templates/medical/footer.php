            ...
            <div class="col-lg-6">
             ...
             <div class="col-lg-6 text-lg-end">
               <div class="legal-links d-flex gap-3 flex-wrap justify-content-lg-end">
                 <?php
                 // Load footer pages from database (created via admin/pages)
                 if (!empty($footer_pages)) {
                     foreach ($footer_pages as $footer_page):
                         if ($footer_page->status === 'published' && $footer_page->show_in_footer):
                 ?>
                 <a href="<?php echo base_url('page/' . $footer_page->slug); ?>" class="text-light text-decoration-none" style="font-size: 0.9rem;">
                     <?php echo htmlspecialchars($footer_page->title); ?>
                 </a>
                 <?php
                         endif;
                     endforeach;
                     ...
                     foreach ($legal_pages as $slug => $title):
                         $page_path = APPPATH . 'views/templates/medical/pages/' . $slug . '.php';
                         if (file_exists($page_path)):
                 ?>
                 <a href="<?php echo base_url($slug); ?>" class="text-light text-decoration-none" style="font-size: 0.9rem;"><?php echo $title; ?></a>
                 <?php
                         endif;
                     endforeach;
                 }
      ...
      <div id="whatswidget-widget-wrapper" class="whatswidget-widget-wrapper" style="all:revert;">
          ...
          <script id="whatswidget-script" type="text/javascript">
              ...
              function openChat() {
                  ...
                  document.getElementById("whatswidget-conversation-message-outer").style.display = "none") : (document.getElementById("whatswidget-conversation").style.opacity = 0, document.getElementById("whatswidget-conversation").style.display = "none", chatOpen = !1)
              }
          </script>
      </div>
