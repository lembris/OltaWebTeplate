...
$hero_images = [
    'college' => 'dmi_inner_hero_one.jpg',
    'tourism' => 'bg_1.jpg',
    'medical' => 'bg_1.jpg'
];
$hero_image = isset($hero_images[$template]) ? $hero_images[$template] : 'bg_1.jpg';
?>
<section class="hero-wrap hero-wrap-2" style="background-image: url('<?php echo get_template_image($hero_image); ?>');">
